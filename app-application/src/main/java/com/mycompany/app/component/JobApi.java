...
public class JobApi {
    ...
    public void ceateJob(){
        try {
            ...
            String xml = "<flow-definition plugin=\"workflow-job@2.32\">\n" +
                    ...
                    "</flow-definition>";
            // 创建 Job
            jenkinsServer.connection().createJob("test-job",xml);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public void updateJob(){
        try {
            ...
            String xml = "<flow-definition plugin=\"workflow-job@2.32\">\n" +
                    ...
                    "</flow-definition>";
            // 创建 Job
            jenkinsServer.connection().updateJob("test-job",xml);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public void getJob(String jobName){
        try {
            // 获取 Job 信息
            JobWithDetails job = jenkinsServer.connection().getJob(jobName);
            // 获取 Job 名称
    ...
    public void getMavenJob(){
        try {
            // 获取 Job 信息
            MavenJobWithDetails job = jenkinsServer.connection().getMavenJob("test-job");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public void getJobList(){
        try {
            // 获取 Job 列表
            Map<String,Job> jobs = jenkinsServer.connection().getJobs();
    ...
    public void getJobListByView(){
        try {
            // 获取 Job 列表
            Map<String,Job> jobs = jenkinsServer.connection().getJobs("all");
            for (Job job:jobs.values()){
                System.out.println(job.getName());
            }
        } catch (IOException e) {
    ...
    public void getJobConfig(){
        try {
            String xml = jenkinsServer.connection().getJobXml("test-job");
    ...
    public void buildJob(){
        try {
            jenkinsServer.connection().getJob("test-job").build();
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public void buildParamJob(){
        try {
            ...
            // 执行 build 任务
            jenkinsServer.connection().getJob("test-job").build(param);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public void stopLastJobBuild(){
        try {
            // 获取最后的 build 信息
            Build build = jenkinsServer.connection().getJob("test-job").getLastBuild();
            // 停止最后的 build
            build.Stop();
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public void deleteJob(){
        try {
            jenkinsServer.connection().deleteJob("test-job");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public void disableJob(){
        try {
            jenkinsServer.connection().disableJob("test-job");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public void enableJob(){
        try {
            jenkinsServer.connection().enableJob("test-job");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
